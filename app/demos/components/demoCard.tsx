...
export default function DemoCard(props: DemoCard) {
  return (
    <li className="relative w-full md:w-5/12 xl:w-3/12 grid md:grid-cols-8 justify-around group content-center w-min:w-max">
      {props.url && (
        props.internalLink ?
      ...
      <div className="z-10 sm:col-span-6 pl-6 pb-4 pr-2 pt-1">
