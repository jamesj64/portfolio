  ...
  return (
    <main className="lg:flex min-h-screen justify-between">
      <div className="lg:w-2/5 lg:top-0 lg:sticky lg:max-h-screen lg:p-24 p-4">
        ...
        <p className="bg-o-background w-fit text-lg leading-tight antialiased tracking-wider mb-12 font-extralight">Software Engineer seeking Winter 2023 internships.</p>
        <ScrollNav />
